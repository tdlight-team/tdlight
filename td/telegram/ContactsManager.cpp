...
bool ContactsManager::is_user_online(UserId user_id, int32 tolerance, int32 unix_time) const {
  if (unix_time <= 0) {
...
void ContactsManager::memory_stats(vector<string> &output) {
  output.emplace_back("\"users_\":"); output.emplace_back(std::to_string(this->users_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"users_full_\":"); output.emplace_back(std::to_string(this->users_full_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"user_photos_\":"); output.emplace_back(std::to_string(this->user_photos_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"unknown_users_\":"); output.emplace_back(std::to_string(this->unknown_users_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_user_photos_\":"); output.emplace_back(std::to_string(this->pending_user_photos_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"user_profile_photo_file_source_ids_\":"); output.emplace_back(std::to_string(this->user_profile_photo_file_source_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"my_photo_file_id_\":"); output.emplace_back(std::to_string(this->my_photo_file_id_.size()));
  output.emplace_back(",");
  output.emplace_back("\"user_full_file_source_ids_\":"); output.emplace_back(std::to_string(this->user_full_file_source_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"chats_\":"); output.emplace_back(std::to_string(this->chats_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"chats_full_\":"); output.emplace_back(std::to_string(this->chats_full_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"unknown_chats_\":"); output.emplace_back(std::to_string(this->unknown_chats_.size()));
  output.emplace_back(",");
  output.emplace_back("\"chat_full_file_source_ids_\":"); output.emplace_back(std::to_string(this->chat_full_file_source_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"min_channels_\":"); output.emplace_back(std::to_string(this->min_channels_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"channels_\":"); output.emplace_back(std::to_string(this->channels_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"channels_full_\":"); output.emplace_back(std::to_string(this->channels_full_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"unknown_channels_\":"); output.emplace_back(std::to_string(this->unknown_channels_.size()));
  output.emplace_back(",");
  output.emplace_back("\"invalidated_channels_full_\":"); output.emplace_back(std::to_string(this->invalidated_channels_full_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"channel_full_file_source_ids_\":"); output.emplace_back(std::to_string(this->channel_full_file_source_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"secret_chats_\":"); output.emplace_back(std::to_string(this->secret_chats_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"unknown_secret_chats_\":"); output.emplace_back(std::to_string(this->unknown_secret_chats_.size()));
  output.emplace_back(",");
  output.emplace_back("\"secret_chats_with_user_\":"); output.emplace_back(std::to_string(this->secret_chats_with_user_.size()));
  output.emplace_back(",");
  output.emplace_back("\"channel_recommended_dialogs_\":"); output.emplace_back(std::to_string(this->channel_recommended_dialogs_.size()));
  output.emplace_back(",");
  output.emplace_back("\"get_channel_recommendations_queries_\":"); output.emplace_back(std::to_string(this->get_channel_recommendations_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"dialogs_for_discussion_\":"); output.emplace_back(std::to_string(this->dialogs_for_discussion_.size()));
  output.emplace_back(",");
  output.emplace_back("\"inactive_channel_ids_\":"); output.emplace_back(std::to_string(this->inactive_channel_ids_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_user_from_database_queries_\":"); output.emplace_back(std::to_string(this->load_user_from_database_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"loaded_from_database_users_\":"); output.emplace_back(std::to_string(this->loaded_from_database_users_.size()));
  output.emplace_back(",");
  output.emplace_back("\"unavailable_user_fulls_\":"); output.emplace_back(std::to_string(this->unavailable_user_fulls_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_chat_from_database_queries_\":"); output.emplace_back(std::to_string(this->load_chat_from_database_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"loaded_from_database_chats_\":"); output.emplace_back(std::to_string(this->loaded_from_database_chats_.size()));
  output.emplace_back(",");
  output.emplace_back("\"unavailable_chat_fulls_\":"); output.emplace_back(std::to_string(this->unavailable_chat_fulls_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_channel_from_database_queries_\":"); output.emplace_back(std::to_string(this->load_channel_from_database_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"loaded_from_database_channels_\":"); output.emplace_back(std::to_string(this->loaded_from_database_channels_.size()));
  output.emplace_back(",");
  output.emplace_back("\"unavailable_channel_fulls_\":"); output.emplace_back(std::to_string(this->unavailable_channel_fulls_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_secret_chat_from_database_queries_\":"); output.emplace_back(std::to_string(this->load_secret_chat_from_database_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"loaded_from_database_secret_chats_\":"); output.emplace_back(std::to_string(this->loaded_from_database_secret_chats_.size()));
  output.emplace_back(",");
  output.emplace_back("\"dialog_suggested_actions_\":"); output.emplace_back(std::to_string(this->dialog_suggested_actions_.size()));
  output.emplace_back(",");
  output.emplace_back("\"dismiss_suggested_action_queries_\":"); output.emplace_back(std::to_string(this->dismiss_suggested_action_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"uploaded_profile_photos_\":"); output.emplace_back(std::to_string(this->uploaded_profile_photos_.size()));
  output.emplace_back(",");
  output.emplace_back("\"import_contact_tasks_\":"); output.emplace_back(std::to_string(this->import_contact_tasks_.size()));
  output.emplace_back(",");
  output.emplace_back("\"imported_contacts_\":"); output.emplace_back(std::to_string(this->imported_contacts_.size()));
  output.emplace_back(",");
  output.emplace_back("\"resolved_phone_numbers_\":"); output.emplace_back(std::to_string(this->resolved_phone_numbers_.size()));
  output.emplace_back(",");
  output.emplace_back("\"user_messages_\":"); output.emplace_back(std::to_string(this->user_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"channel_messages_\":"); output.emplace_back(std::to_string(this->channel_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_contacts_queries_\":"); output.emplace_back(std::to_string(this->load_contacts_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_imported_contacts_queries_\":"); output.emplace_back(std::to_string(this->load_imported_contacts_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"all_imported_contacts_\":"); output.emplace_back(std::to_string(this->all_imported_contacts_.size()));
  output.emplace_back(",");
  output.emplace_back("\"user_full_contact_require_premium_\":"); output.emplace_back(std::to_string(this->user_full_contact_require_premium_.size()));
  output.emplace_back(",");
  output.emplace_back("\"linked_channel_ids_\":"); output.emplace_back(std::to_string(this->linked_channel_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"restricted_user_ids_\":"); output.emplace_back(std::to_string(this->restricted_user_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"restricted_channel_ids_\":"); output.emplace_back(std::to_string(this->restricted_channel_ids_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"next_all_imported_contacts_\":"); output.emplace_back(std::to_string(this->next_all_imported_contacts_.size()));
  output.emplace_back(",");
  output.emplace_back("\"imported_contacts_unique_id_\":"); output.emplace_back(std::to_string(this->imported_contacts_unique_id_.size()));
  output.emplace_back(",");
  output.emplace_back("\"imported_contacts_pos_\":"); output.emplace_back(std::to_string(this->imported_contacts_pos_.size()));
  output.emplace_back(",");
  output.emplace_back("\"imported_contact_user_ids_\":"); output.emplace_back(std::to_string(this->imported_contact_user_ids_.size()));
  output.emplace_back(",");
  output.emplace_back("\"unimported_contact_invites_\":"); output.emplace_back(std::to_string(this->unimported_contact_invites_.size()));
}
