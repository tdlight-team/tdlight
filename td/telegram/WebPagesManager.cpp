...
void WebPagesManager::memory_stats(vector<string> &output) {
  output.emplace_back("\"web_pages_\":"); output.emplace_back(std::to_string(this->web_pages_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"load_web_page_from_database_queries_\":"); output.emplace_back(std::to_string(this->load_web_page_from_database_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"loaded_from_database_web_pages_\":"); output.emplace_back(std::to_string(this->loaded_from_database_web_pages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_web_page_instant_view_queries_\":"); output.emplace_back(std::to_string(this->load_web_page_instant_view_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"web_page_messages_\":"); output.emplace_back(std::to_string(this->web_page_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"story_web_pages_\":"); output.emplace_back(std::to_string(this->story_web_pages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"url_to_web_page_id_\":"); output.emplace_back(std::to_string(this->url_to_web_page_id_.size()));
  output.emplace_back(",");
  output.emplace_back("\"url_to_file_source_id_\":"); output.emplace_back(std::to_string(this->url_to_file_source_id_.size()));
}
