...
void StickersManager::search_stickers(StickerType sticker_type, string emoji, int32 limit,
...
void StickersManager::on_find_stickers_success(const string &emoji,
  ...
  switch (stickers->get_id()) {
    ...
    case telegram_api::messages_stickers::ID: {
      ...
      return on_search_stickers_succeeded(sticker_type, emoji, std::move(sticker_ids));
    }
    default:
      UNREACHABLE();
  }
...
void StickersManager::on_load_custom_emojis(string emoji, int64 hash, vector<CustomEmojiId> custom_emoji_ids,
  ...
  on_search_stickers_succeeded(StickerType::CustomEmoji, emoji, std::move(sticker_ids));
}
...
void StickersManager::get_premium_stickers(int32 limit, Promise<td_api::object_ptr<td_api::stickers>> &&promise) {
  ...
  search_stickers(StickerType::Regular, "📂⭐️", limit,
...
void StickersManager::memory_stats(vector<string> &output) {
  output.emplace_back("\"stickers_\":"); output.emplace_back(std::to_string(this->stickers_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"sticker_sets_\":"); output.emplace_back(std::to_string(this->sticker_sets_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"short_name_to_sticker_set_id_\":"); output.emplace_back(std::to_string(this->short_name_to_sticker_set_id_.calc_size()));
  output.emplace_back(",");
  output.emplace_back("\"favorite_sticker_ids_\":"); output.emplace_back(std::to_string(this->favorite_sticker_ids_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_old_featured_sticker_sets_queries_\":"); output.emplace_back(std::to_string(this->load_old_featured_sticker_sets_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_favorite_stickers_queries_\":"); output.emplace_back(std::to_string(this->load_favorite_stickers_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"repair_favorite_stickers_queries_\":"); output.emplace_back(std::to_string(this->repair_favorite_stickers_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"sticker_set_reload_queries_\":"); output.emplace_back(std::to_string(this->sticker_set_reload_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"favorite_sticker_file_ids_\":"); output.emplace_back(std::to_string(this->favorite_sticker_file_ids_.size()));
  output.emplace_back(",");
  output.emplace_back("\"attached_sticker_sets_\":"); output.emplace_back(std::to_string(this->attached_sticker_sets_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_viewed_featured_sticker_set_ids_\":"); output.emplace_back(std::to_string(this->pending_viewed_featured_sticker_set_ids_.size()));
  output.emplace_back(",");
  output.emplace_back("\"special_sticker_sets_\":"); output.emplace_back(std::to_string(this->special_sticker_sets_.size()));
  output.emplace_back(",");
  output.emplace_back("\"sticker_set_load_requests_\":"); output.emplace_back(std::to_string(this->sticker_set_load_requests_.size()));
  output.emplace_back(",");
  output.emplace_back("\"custom_emoji_load_queries_\":"); output.emplace_back(std::to_string(this->custom_emoji_load_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_new_sticker_sets_\":"); output.emplace_back(std::to_string(this->pending_new_sticker_sets_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_add_sticker_to_sets_\":"); output.emplace_back(std::to_string(this->pending_add_sticker_to_sets_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_set_sticker_set_thumbnails_\":"); output.emplace_back(std::to_string(this->pending_set_sticker_set_thumbnails_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_animated_emoji_queries_\":"); output.emplace_back(std::to_string(this->pending_get_animated_emoji_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_premium_gift_option_sticker_queries_\":"); output.emplace_back(std::to_string(this->pending_get_premium_gift_option_sticker_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_generic_animations_queries_\":"); output.emplace_back(std::to_string(this->pending_get_generic_animations_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_default_statuses_queries_\":"); output.emplace_back(std::to_string(this->pending_get_default_statuses_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_default_channel_statuses_queries_\":"); output.emplace_back(std::to_string(this->pending_get_default_channel_statuses_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_default_topic_icons_queries_\":"); output.emplace_back(std::to_string(this->pending_get_default_topic_icons_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_get_animated_emoji_click_stickers_\":"); output.emplace_back(std::to_string(this->pending_get_animated_emoji_click_stickers_.size()));
  output.emplace_back(",");
  output.emplace_back("\"pending_on_animated_emoji_message_clicked_\":"); output.emplace_back(std::to_string(this->pending_on_animated_emoji_message_clicked_.size()));
  output.emplace_back(",");
  output.emplace_back("\"being_uploaded_files_\":"); output.emplace_back(std::to_string(this->being_uploaded_files_.size()));
  output.emplace_back(",");
  output.emplace_back("\"emoji_language_codes_\":"); output.emplace_back(std::to_string(this->emoji_language_codes_.size()));
  output.emplace_back(",");
  output.emplace_back("\"emoji_language_code_versions_\":"); output.emplace_back(std::to_string(this->emoji_language_code_versions_.size()));
  output.emplace_back(",");
  output.emplace_back("\"emoji_language_code_last_difference_times_\":"); output.emplace_back(std::to_string(this->emoji_language_code_last_difference_times_.size()));
  output.emplace_back(",");
  output.emplace_back("\"reloaded_emoji_keywords_\":"); output.emplace_back(std::to_string(this->reloaded_emoji_keywords_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_emoji_keywords_queries_\":"); output.emplace_back(std::to_string(this->load_emoji_keywords_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"load_language_codes_queries_\":"); output.emplace_back(std::to_string(this->load_language_codes_queries_.size()));
  output.emplace_back(",");
  output.emplace_back("\"emoji_suggestions_urls_\":"); output.emplace_back(std::to_string(this->emoji_suggestions_urls_.size()));
  output.emplace_back(",");
  output.emplace_back("\"premium_gift_messages_\":"); output.emplace_back(std::to_string(this->premium_gift_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"dice_messages_\":"); output.emplace_back(std::to_string(this->dice_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"emoji_messages_\":"); output.emplace_back(std::to_string(this->emoji_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"custom_emoji_messages_\":"); output.emplace_back(std::to_string(this->custom_emoji_messages_.size()));
  output.emplace_back(",");
  output.emplace_back("\"dice_emojis_\":"); output.emplace_back(std::to_string(this->dice_emojis_.size()));
  output.emplace_back(",");
  output.emplace_back("\"dice_success_values_\":"); output.emplace_back(std::to_string(this->dice_success_values_.size()));
  output.emplace_back(",");
  output.emplace_back("\"emoji_sounds_\":"); output.emplace_back(std::to_string(this->emoji_sounds_.size()));
  output.emplace_back(",");
  output.emplace_back("\"custom_emoji_to_sticker_id_\":"); output.emplace_back(std::to_string(this->custom_emoji_to_sticker_id_.calc_size()));
}
